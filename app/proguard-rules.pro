...
-keep class com.nicknamecreator.nicknamegenerator.namemaker.activity_app.splash.SplashActivity.** {*; }
-keep class com.nicknamecreator.nicknamegenerator.namemaker.data.** {*; }
