...
import com.nicknamecreator.nicknamegenerator.namemaker.databinding.ActivityCategoryDetailBinding
...
class CategoryDetailActivity : BaseActivity<ActivityCategoryDetailBinding>() {
    ...
    private fun setupRecyclerView() {
        nicknameAdapter = RandomNicknameAdapter { nickname ->
            ...
            overridePendingTransition(com.nicknamecreator.nicknamegenerator.namemaker.R.anim.slide_in_right, com.nicknamecreator.nicknamegenerator.namemaker.R.anim.slide_out_left)
        }
